...
public String moveFakeNews(String[][] matriz) {
    ...
    // Gera um número aleatório de 0 a 3 para representar a direção do movimento diagonal
         ...
         case 1: // Nordeste
            if (row > 0 && col < matriz[row].length - 1) {
                if (matriz[row - 1][col + 1].equals(" ")) {
                    ...
                    matriz[row][col] = " ";
                    return "F3 tentou se mover para o Nordeste, mas a posição está ocupada. F3 foi removida."; //TODO: esse return pra fakenews removida n é necessario
                }
            }
            break;
           case 2: // Sudoeste
